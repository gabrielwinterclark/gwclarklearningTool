...
form1.addEventListener("submit", () => {
    ...
    switch(value) {
        ...
        case "Learning Objective 2, Question 1: Incorrect (B)":
            q1feedback.innerHTML = "Not quite. The correct answer here is yes. Remember, something has intrinsic value by this second definition when it is valued for its nonrelational properties, or those properties that can’t be separated from it. Is a car being well made separable from the car itself?"
            break;
    };
...
form2.addEventListener("submit", () => {
    ...
    switch(value) {
        case "Learning Objective 2, Question 2: Incorrect (A)":
            q2feedback.innerHTML = "Incorrect. The correct answer here is no. Micah loves the movie because it makes them and their friends laugh. Is this a nonrelational property of the movie, or is it something that can be separated from the movie?"
            break;
...
form3.addEventListener("submit", () => {
    ...
    switch(value) {
        case "Learning Objective 2, Question 3: Incorrect (A)":
            q3feedback.innerHTML = "Incorrect. The correct answer is extrincisally. For Wes to value donating blood intrinsically, he would have to value it for some nonrelational (inseparable) property. Is donating blood separable from the fact that it helps people in need? Remember, one way to test if something has intrinsic value is to think about it in a vacuum."
            break;
