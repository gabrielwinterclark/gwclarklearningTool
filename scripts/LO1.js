...
//change the feedback depending on the user's answer
    switch(value) {
        ...
        case "Learning Objective 1, Question 1: Incorrect (B)":
            q1feedback.innerHTML = "Not quite. Remember, something has intrinsic value when it is valuable for itself. Jeremiah does, in fact, value playing the cello for itself: he values it intrinsically. So, the correct answer here is yes."
            break;
    };
...
form2.addEventListener("submit", () => {
    ...
    switch(value) {
        case "Learning Objective 1, Question 2: Incorrect (A)":
            q2feedback.innerHTML = "Incorrect. Think about it: does May value playing the cello for itself, or for something else? In this case, it looks like May values playing the cello in service of something else. So the correct answer is no, she doesn't value it intrinsically. Read on to learn what type of value May assigns to playing the cello!"
            break;
